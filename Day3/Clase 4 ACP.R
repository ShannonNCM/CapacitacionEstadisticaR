...
datos_acp<-cbind(B1P00A03,B1P00A04A,B1P00A04B,B1P02B06A,B1P02B06B,B1P02B24,B1P02B25,B1P02B28)
head(datos_acp)
...
plot(pci14[,1],pci14[,2], type="p",col="red",
     pch=20,cex=2, xlim=c(-4,6),ylim=c(-4,30), 
...
colnames(CorVarPC) <- c("PC1","PC2","PC3","PC4","PC5", "PC6","PC7","PC8","PC9","PC10")
CorVarPC
...
arrows(0,0,CorVarPC[1:8,1],CorVarPC[1:8,2],length=0.1)
